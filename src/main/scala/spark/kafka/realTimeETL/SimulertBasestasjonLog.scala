...
object SimulertBasestasjonLog {
  def main(args: Array[String]): Unit = {
    ...
    while (true) {
      val callOut: String = "20231212%04d".format(random.nextInt(10000))
      val callIn: String = "20231212%04d".format(random.nextInt(10000))
      ...
      val stationLog: StationLog = StationLog(
        "SimulertBasestasjonLog-" + random.nextInt(10),
        callOut,
        callIn,
        callStatus,
      ...
      val record = new ProducerRecord[String, String]("SimulertBasestasjonLog", stationLog.toString)
